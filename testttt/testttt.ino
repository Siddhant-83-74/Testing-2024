...
int pwms[4]={4128,4090,4180,4135};
//=============================================================================
// Loop
//=============================================================================
void loop()
...
Serial.println(max_pwm);
  ...
  if (joystick1.available()) {
    ...
    int z = map(right_y, -128, 128, max_pwm, -max_pwm);

    Serial.printf("LX: %d, LY: %d, RX: %d, RY: %d \r\n", left_x, left_y, right_x, right_y);
    Serial.printf("L-Trig: %d, R-Trig: %d\r\n", pwm_l, pwm_r);
    if(y<0)
      {drive(-pwms[0], m1_pwm, m1_dir);
      //Serial.println("m1");
      drive(pwms[1], m2_pwm, m2_dir);
      drive(pwms[2], m3_pwm, m3_dir);
      drive(-pwms[3], m4_pwm, m4_dir);
}
     else if(y>0)
      {drive(pwms[0], m1_pwm, m1_dir);
      //Serial.println("m1");
...
//      drive(4095, m3_pwm, m3_dir);
//      Serial.println("m3");
//      //drive(0, m4_pwm, m4_dir);
//      }
//      else if(x>0)
//      {
//              drive(4095, m4_pwm, m4_dir);
//              Serial.println("m4");
//        
//        }
